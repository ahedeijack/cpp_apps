...
{
    //Aspa
    Fig[0][0] = 2.5; Fig[0][1] = 22; Fig[0][2]= 1;
    Fig[1][0] = 4.1; Fig[1][1] = 24; Fig[1][2]= 1;
    Fig[2][0] = 4.1; Fig[2][1] = 24; Fig[2][2]= 1;

    Fig2[0][0] = 4.1; Fig2[0][1] = 24; Fig2[0][2]= 1;
    Fig2[1][0] = 4.7; Fig2[1][1] = 26; Fig2[1][2]= 1;
    Fig2[2][0] = 4.7; Fig2[2][1] = 26; Fig2[2][2]= 1;

    Fig3[0][0] = 4.7; Fig3[0][1] = 26; Fig3[0][2]= 1;
    Fig3[1][0] = 4.5; Fig3[1][1] = 27; Fig3[1][2]= 1;
    Fig3[2][0] = 4.5; Fig3[2][1] = 27; Fig3[2][2]= 1;

    Fig4[0][0] = 4.5; Fig4[0][1] = 27; Fig4[0][2]= 1;
    Fig4[1][0] = 6.1; Fig4[1][1] = 26; Fig4[1][2]= 1;
    Fig4[2][0] = 6.1; Fig4[2][1] = 26; Fig4[2][2]= 1;

    Fig5[0][0] = 6.1; Fig5[0][1] = 26; Fig5[0][2]= 1;
    Fig5[1][0] = 6.1; Fig5[1][1] = 23.5; Fig5[1][2]= 1;
    Fig5[2][0] = 6.1; Fig5[2][1] = 23.5; Fig5[2][2]= 1;

    Fig6[0][0] = 6.1; Fig6[0][1] = 23.5; Fig6[0][2]= 1;
    Fig6[1][0] = 5; Fig6[1][1] = 22; Fig6[1][2]= 1;
    Fig6[2][0] = 5; Fig6[2][1] = 22; Fig6[2][2]= 1;

    Fig7[0][0] = 5; Fig7[0][1] = 22; Fig7[0][2]= 1;
    Fig7[1][0] = 2.5; Fig7[1][1] = 22; Fig7[1][2]= 1;
    Fig7[2][0] = 2.5; Fig7[2][1] = 22; Fig7[2][2]= 1;
    //Aspa

    //Submarino
//1
    Fig8[0][0] = 3; Fig8[0][1] = 20; Fig8[0][2]= 1;
    Fig8[1][0] = 5; Fig8[1][1] = 23; Fig8[1][2]= 1;
    Fig8[2][0] = 5; Fig8[2][1] = 23; Fig8[2][2]= 1;
//2
    Fig9[0][0] = 5; Fig9[0][1] = 23; Fig9[0][2]= 1;
    Fig9[1][0] = 12; Fig9[1][1] = 16; Fig9[1][2]= 1;
    Fig9[2][0] = 12; Fig9[2][1] = 16; Fig9[2][2]= 1;
//3
    Fig10[0][0] = 12; Fig10[0][1] = 16; Fig10[0][2]= 1;
    Fig10[1][0] = 16.5; Fig10[1][1] = 14.5; Fig10[1][2]= 1;
    Fig10[2][0] = 16.5; Fig10[2][1] = 14.5; Fig10[2][2]= 1;
//4
    Fig11[0][0] = 16.5; Fig11[0][1] = 14.5; Fig11[0][2]= 1;
    Fig11[1][0] = 16.5; Fig11[1][1] = 10; Fig11[1][2]= 1;
    Fig11[2][0] = 16.5; Fig11[2][1] = 10; Fig11[2][2]= 1;
//5
    Fig12[0][0] = 16.5; Fig12[0][1] = 10; Fig12[0][2]= 1;
    Fig12[1][0] = 3; Fig12[1][1] = 6; Fig12[1][2]= 1;
    Fig12[2][0] = 3; Fig12[2][1] = 6; Fig12[2][2]= 1;
//6
    Fig13[0][0] = 3; Fig13[0][1] = 6; Fig13[0][2]= 1;
    Fig13[1][0] = 3; Fig13[1][1] = 20; Fig13[1][2]= 1;
    Fig13[2][0] = 3; Fig13[2][1] = 20; Fig13[2][2]= 1;
//7
    Fig14[0][0] = 5; Fig14[0][1] = 23; Fig14[0][2]= 1;
    Fig14[1][0] = 16.5; Fig14[1][1] = 14.5; Fig14[1][2]= 1;
    Fig14[2][0] = 16.5; Fig14[2][1] = 14.5; Fig14[2][2]= 1;
...
void Dialog::dibujarFiguraMapeada()
{
    ...
    dibujo.puerto(75-zoom,50-zoom,125+zoom,200+zoom); //:D
...
void Dialog::on_checkBox_stateChanged(int arg1)
{
    ...
    if(this->ui->widget->isEnabled()){
       this->ui->widget->setEnabled(false);
       timer1->stop();
       this->ui->pushButton->clicked(true);
    } else {
